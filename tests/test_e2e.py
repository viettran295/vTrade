...
def test_crossing_ma_graph(page, app_url):
    ...
    expect(page.get_by_text("Crossing MA")).to_be_visible(timeout=60000)
    expect(page.get_by_role("checkbox", name="Crossing MA")).to_be_visible(timeout=60000)
    expect(page.get_by_text("Short moving average")).to_be_visible(timeout=60000)
    expect(page.locator("#short-ma-input")).to_be_visible(timeout=60000)
    expect(page.get_by_text("Long moving average")).to_be_visible(timeout=60000)
    expect(page.locator("#long-ma-input")).to_be_visible(timeout=60000)
    expect(page.get_by_text("SMA", exact=True)).to_be_visible(timeout=60000)
    expect(page.get_by_role("radio", name="SMA")).to_be_visible(timeout=60000)
    expect(page.get_by_text("EWMA")).to_be_visible(timeout=60000)
    expect(page.get_by_role("radio", name="EWMA")).to_be_visible(timeout=60000)
    expect(page.get_by_role("button", name="Apply")).to_be_visible(timeout=60000)
    expect(page.locator("rect").nth(4)).to_be_visible(timeout=60000)
    expect(page.locator(".bg")).to_be_visible(timeout=60000)
...
def test_bollingerbands_graph(page, app_url):
    ...
    page.get_by_role("button", name="Search").click()
    expect(page.get_by_text("Bollinger bands")).to_be_visible(timeout=60000)
    ...
    expect(bb_graph).to_be_visible(timeout=60000)
...
def test_rsi_graph(page, app_url):
    ...
    page.get_by_role("button", name="Search").click()
    expect(page.get_by_text("RSI")).to_be_visible(timeout=60000)
    ...
    expect(rsi_graph).to_be_visible(timeout=60000)
